                                        ...
                                        <tr>
                                            ...
                                            <td class="align-middle">
                                                ...
                                                <p class="m-0">
                                                    ...
                                                    <!-- <a href="<? // base_url('pakar/artikelpenyakit/') . $row['id_penyakit']; 
                                                                    ?>" class="text-small text-danger">Artikel</a> | -->
                                                    <a href="<?= base_url('pakar/deletepenyakit/') . $row['id_penyakit']; ?>" class="text-small text-danger action-delete">Hapus</a>
                                                </p>
                                            </td>
                                            <!-- <td class="align-middle"><? // $row['deskripsi_penyakit'] 
                                                                            ?></td>
                                            <td class="align-middle"><? // $row['saran_penyakit'] 
                                                                        ?></td> -->
                                        </tr>
                                    <?php endforeach; ?>
                                </tbody>
            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-group">
                            <label for="penyakitArtikelFIX">Deskripsi Penyakit</label>
                            <textarea id="penyakitArtikelFIX" cols="30" rows="5" class="form-control" name="deskripsi_penyakit" placeholder="masukkan deskripsi tentang penyakit disini"></textarea>
                        </div>
                        <div class="form-group">
                            <label for="penyakitSaranArtikel">Saran Penyakit</label>
                            <textarea id="penyakitSaranArtikel" cols="30" rows="5" class="form-control" name="saran_penyakit" placeholder="masukkan artikel tentang penyakit disini"></textarea>
